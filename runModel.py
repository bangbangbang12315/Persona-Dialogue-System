...
from seq2seq.models import EncoderRNN, DecoderRNN, MemoryNN, TopKDecoder, Seq2seq
...
if __name__ == "__main__":
    ...
    user_vocab_list = VocabField.load_vocab(opt.user_vocab_file)
    ...
    user_vocab = VocabField(user_vocab_list, vocab_size=opt.user_vocab_size)
    ...
    memory = MemoryNN(opt.embedding_size,
                      opt.embedding_size)

    seq2seq = Seq2seq(encoder, decoder, memory)
    seq2seq.to(device)
