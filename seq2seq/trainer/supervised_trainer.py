...
class SupervisedTrainer(object):
    ...
    def _train_batch(self, input_variable, input_lengths, target_variable, user, his, query, model, teacher_forcing_ratio):
        loss = self.loss
        # Forward propagation
        decoder_outputs, decoder_hidden, other = model(input_variable, input_lengths, target_variable, user, his, query, 
    ...
    def _train_epoches(self, data, model, start_step,
        ...
        for epoch in range(start_epoch, max_epochs):
            ...
            for batch in data:
                ...
                loss = self._train_batch(src_variables, src_lens.tolist(), tgt_variables, user, his, query, model, teacher_forcing_ratio)
