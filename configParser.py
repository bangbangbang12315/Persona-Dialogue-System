...
parser.add_argument('--train_user_path', action='store', dest='train_user_path', help='Train data file path. //训练集路径。')
parser.add_argument('--dev_user_path', action='store', dest='dev_user_path', help='Dev data file path. //验证集路径。')
parser.add_argument('--test_user_path', action='store', dest='test_user_path', help='Train data file path. //测试集路径。')

parser.add_argument('--train_his_path', action='store', dest='train_his_path', help='Train data file path. //训练集路径。')
parser.add_argument('--dev_his_path', action='store', dest='dev_his_path', help='Dev data file path. //验证集路径。')
parser.add_argument('--test_his_path', action='store', dest='test_his_path', help='Train data file path. //测试集路径。')

parser.add_argument('--train_query_path', action='store', dest='train_query_path', help='Train data file path. //训练集路径。')
parser.add_argument('--dev_query_path', action='store', dest='dev_query_path', help='Dev data file path. //验证集路径。')
parser.add_argument('--test_query_path', action='store', dest='test_query_path', help='Train data file path. //测试集路径。')
...
parser.add_argument('--user_vocab_file', action='store', dest='user_vocab_file', 
                    help='Target vocab file path. //输出文件词表路径。')
...
parser.add_argument('--user_vocab_size', action='store', dest='user_vocab_size', 
                    help='Size of target vocab. //输出词表大小。', default=40000, type=int)
